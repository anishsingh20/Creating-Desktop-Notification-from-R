...
Let's try to get a HTML table and get notifed after regular intervals. Here we can scrape a HTML table using [rvest](r-bloggers.com/using-rvest-to-scrape-an-html-table/) package.
...
StateCOVID_19 <- na.omit(StateCOVID_19)
 ...
 msg3 <- paste(StateCOVID_19[2,2],"\nConfirmed:",StateCOVID_19[2,3],",", "Recovered:  ",StateCOVID_19[2,4],",", "Deaths:  ",StateCOVID_19[2,5], ",", "Active: ",StateCOVID_19[2,6])
